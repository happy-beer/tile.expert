...
{
    #[OA\Post(
        path: '/api/orders/soap',
        summary: 'Create order from SOAP XML payload',
        ...
        responses: [
            new OA\Response(response: 200, description: 'SOAP success response'),
            new OA\Response(response: 400, description: 'SOAP client fault'),
            new OA\Response(response: 500, description: 'SOAP server fault'),
        ],
    )]
